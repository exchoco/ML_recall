...
if __name__=='__main__':
    ...
    # siam_enc.load_state_dict(torch.load("./mod_weight/TriEncoder330.pt"))
    # siam_dec.load_state_dict(torch.load("./mod_weight/TriDecoder330.pt"))
    # start_epoch = 330
    siam_enc.to(device)
    siam_dec.to(device)
    ...
    for epoch in range(start_epoch, start_epoch + args.epoch + 1):
        ...
        for idx, x in enumerate(batch):
            ...
            enc_triplet_loss = 5000 * triplet_criterion(out_anchor[3], out_pos[3], out_neg[3])
